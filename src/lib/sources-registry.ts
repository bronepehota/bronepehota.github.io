...
import starSystemSnowWolvesSquads from '@/data/sources/star_system/snow_wolves/squads.json';
import starSystemSnowWolvesMachines from '@/data/sources/star_system/snow_wolves/machines.json';
