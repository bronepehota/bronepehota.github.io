...
credit:
  ...
  work: "«Хало и Вахо 2» — кампания (docx, 2020)"
units:
...
Война за богатейшие шахты Мантиса в самом разгаре. Кто захватит богатства планеты, а кто разорится — покажут грядущие бои.
