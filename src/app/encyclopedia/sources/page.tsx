      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 py-8 md:py-14 pb-16">
        ...
        >
          ...
          <div className="space-y-4 text-military-sand/80 leading-relaxed text-sm md:text-[15px] max-w-[65ch]">
            ...
            <p>
              <strong className="text-military-sand">Оригинальные тексты полностью не воспроизводятся.</strong>{' '}
              Нарративные тексты (главы истории, кампании, досье вселенной, каталог) — наши
              адаптации: норма — не более 11 совпадающих слов подряд с первоисточником —
              проверяется автоматически при каждой сборке. Справочные досье техники цитируют
              фрагменты официального справочника с атрибуцией — блок «Первоисточник» со ссылкой
              стоит на каждой странице юнита.
            </p>
          </div>
        </section>
