...
**Попробуйте** на [сайте проекта](https://bronepehota.github.io/) · отдельно — [калькулятор боя](https://bronepehota.github.io/calculator).
...
1. Откройте https://bronepehota.github.io/
...
Или сразу в **[калькулятор боя](https://bronepehota.github.io/calculator)** — рассчитать выстрел, ближний бой или гранату без создания армии.
