...
В источнике Star System: **31 отряд пехоты** и **28 боевых машин** — всего **59 уникальных юнитов**.
...
Приложение поддерживает несколько источников армейских листов — выбирайте при создании армии:

* **Star System (сообщество)** — расширенные армлисты от сообщества [Star System](https://vk.com/bp_bnp): 31 отряд пехоты и 28 боевых машин (59 юнитов). Базовый источник по умолчанию.
* **Технолог Классик (официальный)** — оригинальные армлисты от компании [Технолог](http://www.tehnolog.ru/): 33 отряда пехоты по трём фракциям.

Любой источник сочетается с любым набором правил (см. ниже). Также есть встроенный **редактор** для создания собственных армлистов.
...
Остальные изображения и армлисты — от сообщества **[Star System — Бронепехота B&P](https://vk.com/bp_bnp)** (см. раздел «Благодарности»).
