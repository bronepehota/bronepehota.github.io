...
* **Ввод параметров** — дальность (D6/D12/D20), мощность, ближний бой, ранг через военный интерфейс
* **Модификаторы** — баффы, дебаффы и ручная корректировка значений
* **История ввода** — запоминает часто используемые значения кубиков
* **Два набора правил** — Технолог и Стар Систем

### Дополнительно

* **Анимация кубиков** — визуализация бросков с результатами (D6, D12, D20)
* **PWA** — установка на мобильное устройство для оффлайн-доступа
