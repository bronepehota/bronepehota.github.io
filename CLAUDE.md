...
(ход 2 = «реальный бой»), `battle_entry` (from: landing_hero | landing_factions | encyclopedia_unit | encyclopedia_factions) — мосты в /app, `app_open` (вход в /app), `editor_unit_saved`, `pwa_install`. Спека+таксономия:
