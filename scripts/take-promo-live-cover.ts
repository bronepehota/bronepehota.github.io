...
const slides: Slide[] = [
  {
    ...
    title: 'БРОНЕПЕХОТА',
    description: 'Собирайте армию. Отслеживайте состояние отрядов в бою. Рассчитывайте попадания и урон.',
    features: ['Любые фракции', 'Редактор отрядов', 'Бесплатно', 'PWA'],
    phone1: '01-landing.png',
  },
  {
